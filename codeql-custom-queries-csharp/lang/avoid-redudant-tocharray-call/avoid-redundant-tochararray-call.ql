/**
 * @name Avoid redundant 'ToCharArray' call
 * @description A foreach loop can iterate directly over a string. Calling 'ToCharArray()' first allocates a useless array.
 * @kind problem
 * @problem.severity warning
 * @id csharp/gci2333-avoid-redundant-to-char-array-call
 * @tags performance
 */
